...
def main():
	...
	url = 'See [1] at https://apache-patchy.gitbook.io/guide/info-leakage'
	...
	url = 'See [2] at https://apache-patchy.gitbook.io/guide/info-leakage'
	ch_setting_func = 'find_replace'
	user_change = user_prompt_settings(setting, url, bp_setting)
	if user_change:
		working_list = get_working_list(file_list, setting)
	...
	url = 'See [2] at https://apache-patchy.gitbook.io/guide/dos-attacks'
	ch_setting_func = 'find_replace'
	user_change = user_prompt_settings(setting, url, bp_setting)
	if user_change:
		working_list = get_working_list(file_list, setting)
	...
	url = 'See [3] at https://apache-patchy.gitbook.io/guide/info-leakage'
	ch_setting_func = 'find_replace'
	user_change = user_prompt_settings(setting, url, bp_setting)
	if user_change:
		working_list = get_working_list(file_list, setting)
	...
	url = 'See [1] https://apache-patchy.gitbook.io/guide/dos-attacks'
	ch_setting_func = 'find_replace'
	user_change = user_prompt_settings(setting, url, bp_setting)
	if user_change:
		working_list = get_working_list(file_list, setting)
	...
	url = 'See [3] https://apache-patchy.gitbook.io/guide/dos-attacks'
	ch_setting_func = 'find_replace'
	user_change = user_prompt_settings(setting, url, bp_setting)
	if user_change:
		working_list = get_working_list(file_list, setting)
	...
	url = 'See [4] at https://apache-patchy.gitbook.io/guide/dos-attacks'
	ch_setting_func = 'find_replace'
	user_change = user_prompt_settings(setting, url, bp_setting)
	if user_change:
		working_list = get_working_list(file_list, setting)
	...
	url = 'See [1] https://apache-patchy.gitbook.io/guide/logging-monitoring-maintenance'
	ch_setting_func = 'find_replace'
	user_change = user_prompt_settings(setting, url, bp_setting)
	if user_change:
		working_list = get_working_list(file_list, setting)
